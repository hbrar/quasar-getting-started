...
1.  MANUAL:
		...
		a. Create myapp/dist/index.html as below:
...
2.  Using html-webpack-plugin. The plugin will generate an HTML5 file for you that includes all your webpack bundles in the body using script tags.
